    ...
    return (
        <div className="aboutme">
            <div className="landing">
                ...
                <div className="links">
                    <a className="link-hover" aria-label="My Resume" href="/GabrielMM-CV.pdf" download="GabrielMM-CV.pdf">
                    ...
                    <a className="link-hover" aria-label="My email" href="mailto:gabrielmm.00@gmail.com">
                    ...
                    <a className="link-hover" aria-label="My GitHub" target="_blank" href="https://github.com/gabriel-m-m">
                    ...
                    <a className="link-hover" aria-label="My LinkedIn" target="_blank" href="https://www.linkedin.com/in/gabriel-moosmann-mendez/">
