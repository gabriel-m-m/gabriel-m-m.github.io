        ...
        <div className="aboutme">
            <div className="landing">
                ...
                <div className="links">
                    ...
                    <a target="_blank" href="https://github.com/gabriel-m-m">
                    ...
                    <a target="_blank" href="https://www.linkedin.com/in/gabriel-moosmann-mendez/">
            ...
            <div className="pfp-container">
                <img alt="me" className="pfp" height="1410" width="940" src="images/me.png"/>
            </div>
        </div>
    )
}
